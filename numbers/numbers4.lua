...
local function showAnswers(n)
	...
	if asign.x==centerX-60*xscale or asign.x==centerX+10*xscale then
		asign:scale(0.7*xscale,0.7*xscale)
		asign.y=asign.y+10*yscale
		atext:scale(0.7*xscale,0.7*xscale)
	...
	if bsign.x==centerX-60*xscale or bsign.x==centerX+10*xscale then
		bsign:scale(0.7*xscale,0.7*xscale)
		bsign.y=bsign.y+10*yscale
		btext:scale(0.7*xscale,0.7*xscale)
	...
	if csign.x==centerX-60*xscale or csign.x==centerX+10*xscale then
		csign:scale(0.7*xscale,0.7*xscale)
		csign.y=csign.y+10*yscale
		ctext:scale(0.7*xscale,0.7*xscale)
	...
	if dsign.x==centerX-60*xscale or dsign.x==centerX+10*xscale then
		dsign:scale(0.7*xscale,0.7*xscale)
		dsign.y=dsign.y+10*yscale
		dtext:scale(0.7*xscale,0.7*xscale)
